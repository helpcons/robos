...
codigos = [
    202291, 202309, 202325, 203760, 204305, 204321, 206052, 206060, 206078
]
...
df.to_excel("tabela_formatada1.xlsx", index=False)

print("Tabela salva como 'tabela_formatada1.xlsx'.")
navegador.quit()
