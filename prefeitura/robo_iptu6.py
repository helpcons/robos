...
codigos = [
    207621, 207639, 207647, 207654, 207662, 208306, 214189, 214197, 214205
]
...
df.to_excel("tabela_formatada6.xlsx", index=False)

print("Tabela salva como 'tabela_formatada6.xlsx'.")
navegador.quit()
