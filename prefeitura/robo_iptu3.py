...
codigos = [
    206300, 206318, 206326, 206334, 206342, 206367, 206383, 206391, 206409
]
...
df.to_excel("tabela_formatada3.xlsx", index=False)

print("Tabela salva como 'tabela_formatada3.xlsx'.")
navegador.quit()
