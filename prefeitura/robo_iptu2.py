...
codigos = [
    206086, 206219, 206227, 206235, 206250, 206268, 206276, 206284, 206292
]
...
df.to_excel("tabela_formatada2.xlsx", index=False)

print("Tabela salva como 'tabela_formatada2.xlsx'.")
navegador.quit()
