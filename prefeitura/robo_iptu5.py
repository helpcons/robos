...
codigos = [
    201863, 201871, 201889, 201897, 201913, 201921, 201954, 201988, 201996
]
...
df.to_excel("tabela_formatada5.xlsx", index=False)

print("Tabela salva como 'tabela_formatada5.xlsx'.")
navegador.quit()
